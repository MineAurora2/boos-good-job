...
把 `web_script.js` 内容粘贴到 Tampermonkey 中，然后打开 Boss 直聘页面。脚本会在左下角显示图片状态窗，提供“开始/继续”和“暂停”按钮，并可展开/收起及清空本地日志；“结束”操作仍仅由 Dashboard 提供。

状态窗默认不展开设置。右键状态窗的图片或状态文字打开设置面板，可填写：
...
7. 打开 Boss 直聘页面，右键左下角状态窗设置账号标识和后端地址
